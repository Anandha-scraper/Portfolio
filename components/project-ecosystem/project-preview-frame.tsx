...
/**
 * ProjectPreviewFrame — the screenshot pane of ProjectDungeonPanel. Renders
 * /project-preview.webp (a pixel-art "browser window" mockup) as the frame,
 * with the current previewImage shown inside its measured content viewport,
 * and a small dot/arrow switcher when a project has more than one. No
 * internal scrolling — index toggling instead.
 *
